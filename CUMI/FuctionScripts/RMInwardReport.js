jQuery(function ($) {
    ...
    function BindTable() {
        ...
        $.ajax({
            ...
            success: function (Result) {
                ...
                var RMInwarddts = JSON.parse(pageload);


                BindTab(RMInwarddts, '1');
            }
        });
        $(".loader").hide("slow");
    }
    ...
    function BindTab(ResData, type) {
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                "language": {
                    "emptyTable": "RM Inward Report No records found.."
                },
                'bSort': false,
                'aoColumns': [
    ...
    $('#btnsubmit1').click(function () {
        ...
        GenerateRMInwardReport();
    });

    function GenerateRMInwardReport() {
