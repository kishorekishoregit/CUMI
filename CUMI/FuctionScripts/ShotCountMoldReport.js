jQuery(function ($) {
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    { className: "text-capitalize", 'data': 'Date Of Short' },
                    { className: "text-capitalize", 'data': 'Shot Count' },
                  /*  { className: "text-capitalize", 'data': 'Total ShotCount' },*/
                    //{
                    //    /*className: "text-capitalize", 'data': 'Total ShotCount',*/
    ...
    function GenerateStock() {
        ...
        formData.append('Mold', $('#ddlmolditemcode').val());

        $.ajax({
            url: 'ShotCountReportGenerate',
            contentType: false,
            processData: false,
