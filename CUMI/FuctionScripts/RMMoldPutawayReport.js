jQuery(function ($) {
    ...
    function BindTable() {
        ...
        $(".loader").show("slow");
        $.ajax({
            url: 'RMMoldPutawayreportPageLoad',
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    { className: "text-capitalize", 'data': 'RM ItemCode' },
                    { className: "text-capitalize", 'data': 'RM Description' },
                    { className: "text-capitalize", 'data': 'Barcode' },
                    { className: "text-capitalize", 'data': 'Quantity' },
                    { className: "text-capitalize", 'data': 'Picked Quantity' },
                    { className: "text-capitalize", 'data': 'Rejected Quantity' },
                ...
                buttons: [
                    ...
                    {
                        extend: 'excelHtml5',
                        title: 'Mold Inward Or Interlinking Report',
            ...
            $('#dynamic-table').dataTable({
                "language": {
                    "emptyTable": "Mold Inward Or Interlinking Report No records found.."
                },
                'bSort': false,
                'aoColumns': [
