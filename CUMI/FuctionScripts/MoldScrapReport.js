    ...
    function BindTable() {
        ...
        $.ajax({
            ...
            success: function (Result) {
                ...
                var MoldScrapdts = JSON.parse(pageload);
                BindTab(MoldScrapdts, '1');
            }
        });
        $(".loader").hide("slow");
    }
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    { className: "text-capitalize", 'data': 'Mold Scrap Date' },
            ...
            $('#dynamic-table').dataTable({
                "language": {
                    "emptyTable": "Mold Scrap Report No records found.."
                },
                'bSort': false,
                'aoColumns': [
