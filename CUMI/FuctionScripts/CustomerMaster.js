jQuery(function ($) {
    ...
    function BindTable() {
        ...
        $.ajax({
            ...
            success: function (Result) {
                ...
                $("#ddlRecordStatus").empty().append('<option value="">Select an Option</option>');;
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    { className: "text-capitalize",'data': 'Mobile No' },
                    { className: "text-capitalize",'data': 'Ship To Address' },
    ...
    function save() {
        ...
        if (window.FormData !== undefined) {
            ...
            formData.append('CustCode', $('#txtCustomerId').val());
            formData.append('CustName', $('#txtCustomername').val());
        ...
        $.ajax({
            ...
            success: function (data) {
              ...
              //  $('#ddlemployeeid').val(resJ[0].EMPLOYEECODE).trigger('change');
                $("#txtCustomerId").val(resJ[0].CUSTOMERID);
                $("#txtCustomername").val(resJ[0].CUSTOMERNAME);
