...
//Hide the All value
$('#DASHBOARD,#MASTER,#TRANSACTION,#USER,#REPORT,#PRINT,#UPLOADS').hide();

$('#RM,#REMIX,#FG,#DISPATCH').hide();

$('#DAS001,#MAS001,#MAS002,#MAS003,#MAS004,#MAS005,#MAS006,#MAS007,#TRA001,#TRA002,#TRA003,#TRA004,#TRA005,#TRA006,#TRA007,#TRA008,#TRA009,#RPT001,#RPT002,#RPT003,#RPT004,#RPT005,#RPT006,#RPT007,#RPT008,#RPT009,#RPT010,#RPT011,#UAC001,#UAC002,#PRT001,#FUP001,#FUP002,#FUP003').hide();
...
function ScreenDetails(Userdetails, Screendetails) {
    ...
    $.each(Screendetails, function (i, v) {
        ...
        if (v["FUNCTIONNAME"] == "UPLOADS") { $('#UPLOADS').show(); }
