jQuery(function ($) {
    ...
    function BindTable() {
        ...
        $(".loader").show("slow");
        $.ajax({
            url: 'GetTransporterMasterPageLoad',
            ...
            success: function (Result) {
                ...
                var Type = JSON.parse(pageload[1]);
                var Status = JSON.parse(pageload[2]);
                var DETAILS = JSON.parse(pageload[3]);
                ...
                $("#ddltype").empty().append('<option value="">Select an Option</option>');
                $.each(Type, function () {
                    $("#ddltype").append($("<option></option>").val(this["METADATADESCRIPTION"]).html(this["METADATADESCRIPTION"]));
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    // { 'data': 'Employee Code' },
                    { className: "text-capitalize",'data': 'Type' },
                    { className: "text-capitalize",'data': 'Transporter' },
    ...
    $('#Transpoter-form').parsley().on('field:validated', function () {
    ...
    function save() {
        ...
        if (window.FormData !== undefined) {
            ...
            formData.append('Transporter', $('#txttransportername').val());
    ...
    function GetEmployeeDetailsByID(autoid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#ddlPlant').trigger("chosen:updated");
                $("#ddltype").val(resJ[0].TYPE).trigger('change');
                $("#txttransportername").val(resJ[0].TRANSPORTERNAME);
