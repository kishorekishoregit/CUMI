jQuery(function ($) {
    ...
    function BindTable() {
        ...
        $(".loader").show("slow");
        $.ajax({
            url: 'PageloadMoldReconditionReport',
            ...
            success: function (Result) {
                ...
                var MoldReconditiondts = JSON.parse(pageload);
                BindTab(MoldReconditiondts, '1');
            }
        });
        $(".loader").hide("slow");
    }
        ...
        if (exampleRecord) {
            ...
            $('#dynamic-table').dataTable({
                ...
                columns: [
                    ...
                    { className: "text-capitalize", 'data': 'Mold Recondition Date' },
                    { className: "text-capitalize", 'data': 'Mold Item Code' },
                    { className: "text-capitalize", 'data': 'RFID No' },
                    { className: "text-capitalize", 'data': 'Qauntity' },
            ...
            $('#dynamic-table').dataTable({
                "language": {
                    "emptyTable": "Mold Recondition Report No records found.."
                },
                'bSort': false,
                'aoColumns': [
